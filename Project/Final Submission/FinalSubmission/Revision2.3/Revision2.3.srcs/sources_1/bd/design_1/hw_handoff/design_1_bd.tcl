...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net Top_0_hdmi_blue [get_bd_pins Top_0/hdmi_blue] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net Top_0_hdmi_enable [get_bd_pins Top_0/hdmi_enable] [get_bd_pins rgb2dvi_0/vid_pVDE]
  connect_bd_net -net Top_0_hdmi_green [get_bd_pins Top_0/hdmi_green] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net Top_0_hdmi_hsync [get_bd_pins Top_0/hdmi_hsync] [get_bd_pins rgb2dvi_0/vid_pHSync]
  connect_bd_net -net Top_0_hdmi_red [get_bd_pins Top_0/hdmi_red] [get_bd_pins xlconcat_0/In0]
  ...
  connect_bd_net -net clk_wiz_0_clk_slow [get_bd_pins Top_0/Clk] [get_bd_pins blk_mem_gen_0/clka] [get_bd_pins clk_wiz_0/clk_slow] [get_bd_pins rgb2dvi_0/PixelClk]
